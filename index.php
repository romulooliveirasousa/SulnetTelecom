        ...
        <div class="container">
            ...
            <div class="col-md-4 text-center azul" >
                <div class="row">
                    ...
                    <a href="#" class="saiba-mais-full bg-amarelo">saiba mais sobre este serviço</a>
                </div>
            </div>
            <div class="col-md-4 text-center azul" >
                <div class="row">
                    ...
                    vai até você.
                    <a href="#" class="saiba-mais-full bg-verde">saiba mais sobre este serviço</a>
                </div>
            </div>
            <div class="col-md-4 text-center azul" >
                <div class="row">
                    ...
                    qualquer situação.
                    <a href="#" class="saiba-mais-full bg-vermelho">saiba mais sobre este serviço</a>
                </div>
            </div>
        </div>
    ...
    <div class="area-atuacao">
        ...
        <div class="container">
            ...
            <div class="col-md-5 col-md-offset-1">
                ...
                <div class="verde">
                    <a href="#" class="saiba-mais-full bg-verde text-center">Saiba mais sobre as regiões que atendemos</a>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <a href="$"><i class="icone arrow-right"></i>Área de Atuação</a><br/>
                ...
                <div class="col-md-3">
                    ...
                    <a href="#"><i class="icone arrow-right"></i>Hospedagem de Sites</a><br/>
                    <a href="#"><i class="icone arrow-right"></i>Backup</a><br/>
